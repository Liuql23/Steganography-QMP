function [stego,Pchange] = f_sim_embedding(cover, costmat, payload, params)

%% Get embedding costs
% inicialization
cover = double(cover);
seed = params; %% seed for location selection
wetCost = 10^10;
...
[stego,Pchange] = f_EmbeddingSimulator_seed(cover, rhoP1, rhoM1, payload*numel(cover),seed); 
